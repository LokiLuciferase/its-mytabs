...
import { faArrowRightFromBracket, faArrowRightToBracket, faCheck, faFile, faFolder, faGear, faMagnifyingGlass, faPause, faPlay, faPlus, faUser, faUserGroup, faXmark } from "@fortawesome/free-solid-svg-icons";
