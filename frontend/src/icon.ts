...
import { faArrowRightFromBracket, faArrowRightToBracket, faCheck, faFile, faFolder, faGear, faMagnifyingGlass, faPause, faPlay, faPlus, faStar, faUser, faUserGroup, faXmark } from "@fortawesome/free-solid-svg-icons";
